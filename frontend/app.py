    ...
    if request.method == 'POST':
        ...
        if form_2:
            ...
            return render_template('main.html', name=res, split_colors=split_colors, split_price=split_price,
                                   ...
                                   dns_sale=database.get_goods_with_max_sale(form_2, checkbox_status)[1],
                                   citilink_sale=database.get_goods_with_max_sale(form_2, checkbox_status)[0],
                                   organaze_sale=organaze_sale)
        elif form_4:
            ...
            return render_template('main.html', name=res, split_colors=split_colors, split_price=split_price,
                                   ...
                                   dns_sale=database.get_goods_with_max_sale(form_4, checkbox_status)[1],
                                   citilink_sale=database.get_goods_with_max_sale(form_4, checkbox_status)[0],
                                   organaze_sale=organaze_sale)
            ...
            return render_template('main.html', name=res, split_colors=split_colors, split_price=split_price,
                                   ...
                                   dns_sale=database.get_goods_with_max_sale(form_3.lower(), checkbox_status)[1],
                                   citilink_sale=database.get_goods_with_max_sale(form_3.lower(), checkbox_status)[0],
                                   organaze_sale=organaze_sale)
        else:
            ...
            return render_template('main.html', name=res, split_colors=split_colors, split_price=split_price, req=req,
                                   ...
                                   dns_sale=database.get_goods_with_max_sale(req, checkbox_status)[1],
                                   citilink_sale=database.get_goods_with_max_sale(req, checkbox_status)[0],
                                   organaze_sale=organaze_sale)
    else:
        return render_template('main.html', name=name, req_list=req_list)
